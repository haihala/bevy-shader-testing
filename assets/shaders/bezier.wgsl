...
#import "shaders/helpers.wgsl"::{PI, easeInOutBounce};

const cycle_duration = 1.0;
const cycle_cooldown = 2.0;
...
const right_color: vec4f = vec4(1.0, 0.1, 0.1, 1.0);
...
fn fragment(
    ...
    let cycle = min(1.0, speed * fract(time / total_duration));
